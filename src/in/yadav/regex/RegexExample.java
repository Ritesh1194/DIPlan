...
public class RegexExample {
	...
	public static void main(String[] args) {
		...
		/*
		 * Boundary Matchers example ^ denotes start of the line $ denotes end of the
		 * line
		 */
		System.out.println(Pattern.matches("^This$", "This is Ritesh")); // False
		System.out.println(Pattern.matches("^This$", "This")); // True
		System.out.println(Pattern.matches("^This$", "Is This Ritesh")); // False
	}
}